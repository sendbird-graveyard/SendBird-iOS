...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    OpenChannelViewController *vc = [[OpenChannelViewController alloc] init];
    [vc setTitle:self.channels[indexPath.row].name];
    [vc setSenderId:[SBDMain getCurrentUser].userId];
    [vc setSenderDisplayName:[SBDMain getCurrentUser].nickname];
    [vc setChannel:self.channels[indexPath.row]];
