...
/**
 A default `SendBird_SRSecurityPolicy` implementation specifies socket security and
 validates the certificate chain.

 Use a subclass of `SendBird_SRSecurityPolicy` for more fine grained customization.
 */
