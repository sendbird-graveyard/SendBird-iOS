...
class GroupChannelIncomingAudioFileMessageTableViewCell: UITableViewCell {
    ...
    func setMessage(currMessage: SBDFileMessage, prevMessage: SBDBaseMessage?, nextMessage: SBDBaseMessage?) {
        ...
        let longClickProfileGesture = UILongPressGestureRecognizer(target: self, action: #selector(GroupChannelIncomingAudioFileMessageTableViewCell.longClickProfile(_:)))
        ...
        let clickProfileGesture = UILongPressGestureRecognizer(target: self, action: #selector(GroupChannelIncomingAudioFileMessageTableViewCell.clickProfile))
