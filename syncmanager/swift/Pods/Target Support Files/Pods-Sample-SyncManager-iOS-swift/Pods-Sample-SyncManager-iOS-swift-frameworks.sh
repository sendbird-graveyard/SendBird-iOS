...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${PODS_ROOT}/SendBirdSyncManager/SendBirdSyncManager.framework"
  install_dsym "${PODS_ROOT}/SendBirdSyncManager/SendBirdSyncManager.framework.dSYM"
